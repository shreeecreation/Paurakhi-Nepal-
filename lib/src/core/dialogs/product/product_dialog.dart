          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 15),
                SizedBox(
                    width: 220, child: Center(child: Text('Product Requested !', textAlign: TextAlign.center, style: AppStyles.text16PxSemiBold))),
                const SizedBox(height: 10),
                SizedBox(
                    width: 220,
                    child:
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(
                    width: 220,
                    child: Center(child: Text('Gant Applied Successfully ! !', textAlign: TextAlign.center, style: AppStyles.text16PxSemiBold))),
                const SizedBox(height: 10),
                SizedBox(
                    width: 240,
                    child:
